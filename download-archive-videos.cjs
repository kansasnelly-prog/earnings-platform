...
// Use sample videos from archive.org (public domain, no auth required)
const sampleVideos = [
  {
    url: 'https://archive.org/download/BigBuckBunny_124/Content/big_buck_bunny_720p_1mb.mp4',
...
async function downloadVideos() {
  console.log('=== DOWNLOADING REAL VIDEOS FROM ARCHIVE.ORG ===\n');
