      ...
      <div className="relative p-8 bg-gradient-to-br from-emerald-500/10 via-white/[0.02] to-amber-500/10 border border-emerald-500/20 rounded-2xl overflow-hidden">
        <div className="flex flex-col items-center justify-center py-4 animate-fade-in">
          ...
          <div className="relative w-28 h-28 mb-6">
            <div className="absolute inset-0 rounded-full border-4 border-emerald-500/30 animate-ping" style={{ animationDuration: '1000ms' }} />
          ...
          {bonusState.streak > 0 && (
            <div className="mt-3 animate-slide-up" style={{ animationDelay: '300ms' }}>
              <StreakBadge streak={bonusState.streak} />
            </div>
          )}
        </div>
      ...
      <div className="relative p-8 bg-gradient-to-br from-indigo-500/5 via-white/[0.02] to-purple-500/5 border border-indigo-500/15 rounded-2xl overflow-hidden">
        <div className="flex flex-col items-center justify-center py-8">
          ...
          <div className="relative w-24 h-24 mb-6">
            <div className="absolute inset-0 rounded-full border-2 border-amber-500/20 animate-ping" style={{ animationDuration: '1500ms' }} />
            <div className="absolute inset-2 rounded-full border-2 border-indigo-500/30 animate-ping" style={{ animationDuration: '1800ms', animationDelay: '200ms' }} />
            <div className="absolute inset-4 rounded-full border-2 border-purple-500/20 animate-ping" style={{ animationDuration: '2000ms', animationDelay: '400ms' }} />
            <div className="absolute inset-0 flex items-center justify-center">
      ...
      <div className="relative bg-gradient-to-br from-amber-500/5 via-white/[0.02] to-indigo-500/5 border border-amber-500/15 rounded-2xl overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="relative p-6 md:p-8 flex items-center justify-center min-h-[280px] md:min-h-[350px]">
            ...
            {/* Daily bonus badge */}
            <div className="absolute top-4 right-4 px-3 py-1.5 bg-gradient-to-r from-amber-500/20 to-orange-500/20 backdrop-blur-md border border-amber-500/30 rounded-full animate-slide-up" style={{ animationDelay: '100ms' }}>
          ...
          <div className="p-6 md:p-8 flex flex-col justify-center">
            ...
            <div className="p-4 bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-amber-500/10 border border-amber-500/20 rounded-xl mb-4 animate-slide-up" style={{ animationDelay: '200ms' }}>
        ...
        <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div className="flex items-start gap-4">
            ...
            <div className="relative">
              ...
              {/* Pulse ring */}
              <div className="absolute inset-0 rounded-2xl border-2 border-amber-500/20 animate-ping" style={{ animationDuration: '2000ms' }} />
              {/* 2X badge */}
