...
const MatchingFeed: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-pink-900 to-purple-900 p-4 relative overflow-hidden">
      <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30 animate-pulse-slow"></div>
      <div className="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent"></div>
      <div className="relative z-10 max-w-md mx-auto">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-3xl font-bold text-white animate-glow">Match Feed</h1>
          <div className="flex gap-2">
            ...
            <div className="bg-gradient-to-r from-amber-500/20 to-orange-500/20 backdrop-blur-sm rounded-lg px-4 py-2 border border-amber-500/30">
              <span className="text-amber-400 font-bold animate-glow">{nellyCoins}</span>
        ...
        {currentProfile ? (
          ...
          <Card className="backdrop-blur-xl border-2 border-pink-500/30 shadow-2xl bg-gradient-to-br from-purple-900/40 to-pink-900/40">
            <CardContent className="p-8 text-center">
              ...
              <Button
                className="w-full bg-gradient-to-r from-amber-500 to-orange-600 text-white font-bold py-4 rounded-xl hover:scale-105 transition-all duration-300 shadow-lg shadow-amber-500/50 mb-6 relative overflow-hidden"
                onClick={() => setButtonLoading('google')}
              >
              ...
              <form onSubmit={handleEmailAuth} className="mb-6">
                <div className="bg-gradient-to-br from-purple-950/85 to-pink-950/90 backdrop-blur-xl border-2 border-amber-500/40 rounded-xl p-6 space-y-4 shadow-2xl shadow-amber-500/20">
                  <div>
                    <label className="block text-amber-400 font-bold mb-2 animate-glow">Email Address</label>
                    <input
                      type="email"
                      value={email}
                  ...
                  <div>
                    <label className="block text-amber-400 font-bold mb-2 animate-glow">Password</label>
                    <input
                      type="password"
                      value={password}
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-amber-500 to-orange-600 text-white font-bold py-4 rounded-xl hover:scale-105 transition-all duration-300 shadow-lg shadow-amber-500/50 relative overflow-hidden"
                    onClick={() => setButtonLoading('auth')}
                  >
                    {buttonLoading === 'auth' ? (
                      <div className="absolute inset-0 flex items-center justify-center bg-black/50">
                        <div className="w-8 h-8 border-4 border-amber-400 border-t-transparent rounded-full animate-spin"></div>
              ...
              <div className="bg-gradient-to-br from-purple-950/85 to-pink-950/90 backdrop-blur-xl border-2 border-amber-500/40 rounded-xl p-6 mb-6 shadow-2xl shadow-amber-500/20">
