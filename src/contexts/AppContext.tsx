...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    // Stage 1: Authentication Unification - Eradicate Duplicate Listeners
    // SafeAuthProvider (SafeAuthProvider.tsx) is the single source of truth for auth state
    // We removed the duplicate onAuthStateChange listener to prevent state fractures
    // AppContext now relies on SafeAuthProvider's auth state and only handles user data loading
