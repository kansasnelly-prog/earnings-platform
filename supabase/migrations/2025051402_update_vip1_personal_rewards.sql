-- Create RPC function to update existing VIP1 personal tasks to use predefined reward arrays
-- This fixes the issue where existing tasks still show product-price-based rewards ($5.50+)
